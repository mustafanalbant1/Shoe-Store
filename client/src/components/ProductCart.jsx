...
// Memoize edilmiş seçici düzeltmesi
...
const ProductCart = () => {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center h-[600px] text-red-600">
        Hata: {error}
      </div>
    );
  }
  ...
  if (!products || products.length === 0) {
    return (
      <div className="flex justify-center items-center h-[600px]">
        Henüz ürün bulunmuyor. Lütfen daha sonra tekrar deneyin.
      </div>
    );
  }
